...
//console.log
let laatste = catBreeds.length-1;
console.log("Naam van het laatste kattenras :",catBreeds[laatste].name);
...
laatste = catBreeds[2].temperament.length-1;
console.log("Laatst temperament van de temperamenten van de derde kat :",catBreeds[2].temperament[laatste]);
